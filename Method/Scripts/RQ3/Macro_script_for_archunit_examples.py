...
input_csv = experiment_dir / "dataset" / "RQ4Rule-input.csv"
api_json_dir = experiment_dir / "api_jsons"
opensource_dir = experiment_dir / "dataset" / "Archunit-Explain-main-class"
...
def process_single_rule(rule_name: str, nl_input: str, project_name: str):
    try:
        ...
        java_cmd = [
            ...
            f"./dataset/Archunit-Explain-main-class/{project_name}",
